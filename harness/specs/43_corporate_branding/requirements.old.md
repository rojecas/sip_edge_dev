...
### R5
La propiedad `font-family` del `body` DEBE declarar `"Montserrat", system-ui,
-apple-system, sans-serif` como primera opción, aplicando Montserrat a todos
los elementos de texto en todas las vistas (login, kiosko/\*, admin/\*).
...
### R10
El modal About DEBE usar el logo corporativo (`/static/logo-mayaguez.png`)
como imagen principal en lugar del placeholder actual
(`/static/favicon.png`), con dimensiones de 64x64 píxeles y borde
redondeado.

## Favicon

### R11
El favicon del navegador en `frontend/public/favicon.png` DEBE ser el
isotipo de Mayaguez (versión a color del logo). (YA IMPLEMENTADO)
