...
class AiMultiTurnService:
    ...
    def detect_farewell(self, text: str) -> bool:
        ...
        coincide con FAREWELL_PATTERNS."""
...
| Método `get_or_create_active_conversation()` | `src/sms_persistence.py` | Sin cambios. El nuevo `AiMultiTurnService` lo usa para obtener/crear conversaciones ai_query |
