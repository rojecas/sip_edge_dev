...
Usage:
    python harness/.opencode/scripts/github_sync.py check
    python harness/.opencode/scripts/github_sync.py create --feature-id 7
    python harness/.opencode/scripts/github_sync.py close --feature-id 7
    python harness/.opencode/scripts/github_sync.py comment --feature-id 7 --body "..."
...
def resolve_base():
    """Return the project root (2 levels up from this script under harness/.opencode/scripts/)."""
...
def build_issue_body(feat, spec_path=None):
    """Build issue body from feature description and optional spec files."""
    lines = []
