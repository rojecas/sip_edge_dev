...
def _resolve_event_loop() -> asyncio.AbstractEventLoop:
    ...
    try:
        ...
        logger.info("[TRACE-D2] Running loop id=%s", id(loop))
        return loop
    except RuntimeError:
        new_loop = asyncio.new_event_loop()
        logger.warning("[TRACE-D2] NO running loop! Created NEW loop id=%s", id(new_loop))
        return new_loop
...
async def lifespan(app: FastAPI):
    ...
    # Inicializar SmsSendQueue (F27) G현 cola de envio asincrona
    ...
    # Inicializar IncomingSmsDispatcherV2 (F27) G현 reemplaza v1
...
# ------------------------------------------------------------------
# Agent Router G현 POST /api/agent/query (T21)
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Report Templates Router G현 CRUD (T22)
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Anomaly Router G현 GET /api/anomalies (T23)
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Static files mount G현 serve SPA from src/static/
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Catch-all route G현 serve SPA index.html for non-API/WS/login/health
